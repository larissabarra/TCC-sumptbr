...
def sumarizar(texto):
    ...
    summarizerTR = LsaSummarizer(stemmer)
...
Desde sua popularização, a Web se consolidou como um enorme repositório de dados, abrigando conteúdo, científico ou não, das mais diversas áreas.
...
Já no caso de textos, foco deste trabalho, um sumário contem os principais tópicos abordados.
...
Já no caso de textos, foco deste trabalho, um sumário contem os principais tópicos abordados.Um algoritmo de sumarização poderia selecionar apenas as partes interessantes do vídeo, sem a necessidade de alguém assisti-lo inteiro.
